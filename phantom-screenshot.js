...
page2.onCallback = function(userData) {
  var data = userData || {};
  var options = {
  ...
  if (options.filename) {
    console.log('PSS - Rendering screenshot: ', options.filename);
    page2.render('screenshots/' + options.filename);
  }
...
page2.open("http://localhost:9876/debug.html");
